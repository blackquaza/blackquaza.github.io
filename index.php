...
<body>
    ...
    <article>
        <div class="container text-lightgray">
            <h1>The Storefront</h1>
            <hr>
            <p>
                Welcome to the place where you can buy things from other users.
            </p>
            <p>
                Got something to sell? Fill out the form and be on your way to quick money!
            </p>
            <hr>
            <h3>Featured Item</h3>
            ...
            <?php
                ...
                $query = 'SELECT * FROM CIS245_ProductList ORDER BY Updated DESC LIMIT 1';
